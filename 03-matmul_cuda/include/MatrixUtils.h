...
public:
    ...
    /**
     * Genera matrices segun los parametros dados en los ejercicios
     * @param a dimension de matriz
     * @param b dimension de matriz
     * @param c dimension de matriz
     * @param A primera matriz
     * @param B segunda matriz
     * @param C tercera matriz
     * @param max_val valor maximo que puede tomar cada valor de las matrices
     * @return True si ha sido exitosa la generacion, false en los demas casos
     */
    template<typename T>
    ...
    /**
     * Genera matrices con el valor indicado
     * @param a dimension de matriz
     * @param b dimension de matriz
     * @param c dimension de matriz
     * @param A primera matriz
     * @param B segunda matriz
     * @param C tercera matriz
     * @param val valor de todos los elementos de las matrices
     * @return True si ha sido exitosa la generacion, false en los demas casos
     */
    template<typename T>
    ...
    /**
     * Multiplica dos matrices dadas (En serie)
     * @param A Primera matriz
     * @param B Segunda matriz
     * @param DST Matriz resultado
     * @param A_DIM Dimensiones de la matriz A
     * @param B_DIM Dimensiones de la matriz B
     */
